...
public class TablaServlet extends HttpServlet{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		System.out.println(req.getParameter("menuResultados"));
		...
		String urlToXMLString = "/WEB-INF/xml/" + req.getParameter("menuResultados");
		String urlToXML = this.getServletContext().getRealPath(urlToXMLString);  
